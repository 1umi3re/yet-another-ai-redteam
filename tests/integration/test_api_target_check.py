    ...
    respx.post("https://check.example.com/v1/chat/completions").mock(
        side_effect=[
            ...
            httpx.Response(
                ...
                content=(b'data: {"choices":[{"delta":{"content":"p"}}]}\n\ndata: [DONE]\n\n'),
            ),
        ]
    )
    ...
    async with AsyncClient(transport=ASGITransport(app=app), base_url="http://t") as c:
        ...
        t = await c.post(
            ...
            json={
                ...
                "params": {"name": "check_target", "base_url": "https://check.example.com/v1", "model": "gpt-test"},
    ...
    async with AsyncClient(transport=ASGITransport(app=app), base_url="http://t") as c:
        ...
        t = await c.post(
            ...
            json={
                "name": "bad_target",
                "plugin": "openai_compat",
                "params": {"name": "bad_target", "base_url": "https://bad.example.com/v1", "model": "gpt-test"},
...
async def test_target_check_draft(monkeypatch, tmp_path):
    ...
    async with AsyncClient(transport=ASGITransport(app=app), base_url="http://t") as c:
        ...
        check_resp = await c.post(
            "/api/targets/check",
            headers=h,
            json={
                "name": "draft_target",
                "plugin": "openai_compat",
                "params": {"name": "draft_target", "base_url": "https://draft.example.com/v1", "model": "gpt-draft"},
