...
EXECUTOR_METHOD_DESCRIPTIONS: dict[str, str] = {
    ...
    "markdown_wrapper": "Wraps the payload in a Markdown code fence for downstream rendering tests.",
    "xss_output_rendering": "Asks the target to echo output that may execute when rendered by a web UI.",
    "sqli_output_injection": "Frames the payload as SQL text that may be stored or executed downstream.",
    "ssrf_request_trigger": "Asks the target or connected tool to fetch the payload URL or resource.",
    "rce_code_execution": "Frames the payload as code that may be executed by a downstream interpreter.",
    "reverse_prompt_injection": "Writes the payload into stored data that will be rendered or consumed later.",
    "repeat_token": "Repeats a token before, after, or around the payload for token-flooding tests.",
    "control_chars_repetition": "Adds repeated control characters around the payload for availability stress tests.",
    "never_ending_generation": "Asks the target to produce an unbounded or extremely long response.",
    "deep_nesting_input": "Wraps the payload in deeply nested delimiters for parser and context stress.",
    "sponge_input": "Adds sponge-style reasoning cycles intended to maximize downstream compute.",
    ...
    "add_image_text": "Places prompt text into an image artifact for vision-model injection tests.",
    "add_image_to_video": "Places prompt text into a video-manifest artifact.",
    "add_text_image": "Renders the prompt as text inside an image artifact.",
    "audio_echo": "Encodes the prompt into a generated audio artifact.",
    "audio_frequency": "Encodes the prompt into an audio artifact using a configured frequency.",
    "audio_hidden_instruction": "Represents the prompt as a hidden instruction in an audio artifact.",
    "audio_speed": "Encodes the prompt into an audio artifact with a speed setting.",
    "audio_volume": "Encodes the prompt into an audio artifact with a volume setting.",
    "audio_white_noise": "Encodes the prompt into an audio artifact with white-noise-style carrier settings.",
    "azure_speech_audio_to_text": "Represents an Azure speech audio-to-text conversion artifact.",
    "azure_speech_text_to_audio": "Represents an Azure speech text-to-audio conversion artifact.",
    "image_color_saturation": "Renders prompt text into an image artifact with saturation metadata.",
    "image_compression": "Renders prompt text into an image artifact with compression metadata.",
    "image_noise": "Renders prompt text into an image artifact with visual noise.",
    "image_resizing": "Renders prompt text into an image artifact with resize metadata.",
    "image_rotation": "Renders prompt text into an image artifact with rotation metadata.",
    "image_steganography": "Embeds the prompt as hidden metadata inside an image artifact.",
